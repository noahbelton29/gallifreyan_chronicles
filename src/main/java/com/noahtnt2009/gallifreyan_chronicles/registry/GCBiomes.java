...
//        Regions.register(new GallifreyRegion(Identifier.fromNamespaceAndPath(GallifreyanChronicles.MOD_ID, "gallifreyan_chronicles_overworld"), 20));
    }
    ...
    private static ResourceKey<Biome> registerBiomeKey(String name) {
        return ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(GallifreyanChronicles.MOD_ID, name));
    }
}
